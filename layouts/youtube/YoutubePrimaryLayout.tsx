  ...
  return (
    <div className="youtube">
      ...
      <div className="flex main-layout h-[94vh] gap-2 overflow-hidden">
        <div className="sidemenu xss:hidden md:block md:w-[25%] xl:w-[15%] overflow-y-scroll overflow-x-hidden">
        ...
        <div className="content md:w-[75%] xl:w-[83%] gap-1 xss:p-3 md:p-0">{children}</div>
      </div>
    </div>
  );
};
